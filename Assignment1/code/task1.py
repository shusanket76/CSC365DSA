...
vaersVaxCOVIDID2023 =vaersIDHashmapCovid("../dataset/2023VAERSVAX.csv")[0]
vaersVaxNonDomestics =vaersIDHashmapCovid("../dataset/NonDomesticVAERSVAX.csv")[0]
...
vaersSymptomCovid2023 =vaersSymptomsHashmapCovid(vaersVaxCOVIDID2023,"../dataset/2023VAERSSYMPTOMS.csv")[0]
vaersNonDomesticsSymptoms =vaersSymptomsHashmapCovid(vaersVaxNonDomestics,"../dataset/NonDomesticVAERSSYMPTOMS.csv")[0]
...
vaersDataCovid2023 =vaersDataHashmapCovid(vaersVaxCOVIDID2023,"../dataset/2023VAERSDATA.csv")[0]
vaersNonDomesticsDataCovid =vaersDataHashmapCovid(vaersVaxNonDomestics,"../dataset/NonDomesticVAERSDATA.csv")[0]
...
outputfilename = "VAERS_COVID_NOVEMBER.csv"
...
outputfilename2 = "SYMPTOMDATANOVEMBER.csv"
